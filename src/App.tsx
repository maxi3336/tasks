...
const App = () => {
  return (
    <div className="w-screen h-screen flex flex-col relative gap-6 bg-sky-50/50">
      <div className="mt-8 flex items-center justify-between px-6 sm:px-24">
        ...
        <div className="flex-1 w-full overflow-x-auto pl-2">
          <div className="inline-flex items-center pb-6">
            {cat.map((el, index) => (
              <div
                key={'c' + index}
                className="w-48 h-full mr-4 flex flex-col p-4 pt-6 rounded-2xl bg-white shadow-md shadow-slate-400"
              >
